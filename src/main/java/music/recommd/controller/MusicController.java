...
public class MusicController {
	...
	/**
	 * @api {GET} http://115.28.238.193:8080/music/music?page={page}&size={size}  1-查询所有音乐
	 * @apiName getAll
	 * @apiGroup Smusic
	 * @apiSuccessExample {json} Success-Response: HTTP/1.1 200 OK 
     * {
     * 		//page（默认第0页）表示第几页，从第0页开始，size（默认5条）表示页面大小。
     *  	"status":200
     *  	"data":[
     *  		{
	...
	public String getAll(@RequestParam(value = "page", required = false, defaultValue = "0") Integer page,
		...
		return JSON.toJSONString(this.musicService.findAll(0, 5),
	...
	/**
	 * @api {GET} http://115.28.238.193:8080/music/music/type/{typeId}?page={page}&size={size}  1-查询所有音乐
	 * @apiName getTypeAll
	 * @apiGroup Smusic
	 * @apiSuccessExample {json} Success-Response: HTTP/1.1 200 OK 
     * {
